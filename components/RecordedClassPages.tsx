...
export const RecordedClassEditor: React.FC<{
  ...
  const questionAddButtons = () => (
    <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
      <Button type="button" variant="secondary" className="w-full text-xs px-3" icon={Plus} onClick={() => updateQuiz({ ...quiz, questions: [...quiz.questions, createQuestion('multiple_choice')] })}>Pilihan Ganda</Button>
      <Button type="button" variant="secondary" className="w-full text-xs px-3" icon={Plus} onClick={() => updateQuiz({ ...quiz, questions: [...quiz.questions, createQuestion('true_false')] })}>Benar / Salah</Button>
      <Button type="button" variant="secondary" className="w-full text-xs px-3" icon={Plus} onClick={() => updateQuiz({ ...quiz, questions: [...quiz.questions, createQuestion('long_answer')] })}>Jawaban Panjang</Button>
    </div>
  );
        ...
        {isQuizLoading ? (
          ...
          <div className="space-y-5">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <div className="w-full sm:w-auto"><div className="hidden sm:block">{questionAddButtons()}</div></div>
            </div>
            <div className="sm:hidden">{questionAddButtons()}</div>
